    ...
    <div class="w-full h-screen flex justify-center items-center">
        <div class="text-center">
            <div class="flex flex-row justify-center">
                ...
                <p class="text-6xl font-extrabold text-white mb-4">Digi-Slam </p><img src="img/readg.png" alt="readg"
                    class="h-16">
            </div>
            <p class="text-2xl font-extrabold text-white mb-4">Digital way to keep memories...</p>

            <p class="text-lg text-white">
                Welcome to Digi-Slam, the digital platform that revolutionizes the way you capture and cherish memories.
                Our Digi-Slam application provides a modern and convenient way to create and share slambooks with your
            ...
            <p class="text-lg text-white mt-4">
                Start filling out your digital slambook today and embark on a journey of nostalgia with Digi-Slam!
            </p>
        </div>
    </div>
