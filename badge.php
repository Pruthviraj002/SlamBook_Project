    ...
    <div class="text-center">
        ...
        foreach ($badgeUserCounts as $i => $badgeUserCount) {
            ...
            if ($userCount >= $badgeUserCount) {
                if ($i == 0 && $userCount >= 1) {
                    echo '<div class="text-center font-semibold text-xl bg-white rounded-t-full p-1"><img src="img/bdg1.png" alt="First Badge" class="rounded-full border-2 border-black  hover:scale-105 hover:rotate-12">Awarded for 1 friend</div>';
                } elseif ($i == 1 && $userCount >= 3) {
                    echo '<div class="text-center font-semibold text-xl bg-white rounded-t-full p-1"><img src="img/bdg2.jpg" alt="Second Badge" class="rounded-full border-2 border-black hover:scale-105 hover:rotate-12">Awarded for 3 friends</div>';
                } elseif ($i == 2 && $userCount >= 5) {
                    echo '<div class="text-center font-semibold text-xl bg-white rounded-t-full p-1"><img src="img/bdg3.jpg" alt="Third Badge" class="rounded-full border-2 border-black hover:scale-105 hover:rotate-12">Awarded for 5 friends</div>';
                } elseif ($i == 3 && $userCount >= 7) {
                    echo '<div class="text-center font-semibold text-xl bg-white rounded-t-full p-1"><img src="img/bdg4.png" alt="Third Badge" class="rounded-full border-2 border-black hover:scale-105 hover:rotate-12">Awarded for 7 friends</div>';
                } elseif ($i == 4 && $userCount >= 10) {
                    echo '<div class="text-center font-semibold text-xl bg-white rounded-t-full p-1"><img src="img/bdg5.jpg" alt="Third Badge" class="rounded-full border-2 border-black hover:scale-105 hover:rotate-12">Awarded for 10 friends</div>';
                } elseif ($i == 5 && $userCount >= 15) {
                    echo '<div class="text-center font-semibold text-xl bg-white rounded-t-full p-1"><img src="img/bdg6.jpg" alt="Third Badge" class="rounded-full border-2 border-black hover:scale-105 hover:rotate-12">Awarded for 15 friends</div>';
                } elseif ($i == 6 && $userCount >= 20) {
                    echo '<div class="text-center font-semibold text-xl bg-white rounded-t-full p-1"><img src="img/bdg7.jpg" alt="Third Badge" class="rounded-full border-2 border-black hover:scale-105 hover:rotate-12">Awarded for 20 friends</div>';
                } elseif ($i == 7 && $userCount >= 25) {
                    echo '<div class="text-center font-semibold text-xl bg-white rounded-t-full p-1"><img src="img/bdg8.jpg" alt="Third Badge" class="rounded-full border-2 border-black hover:scale-105 hover:rotate-12">Awarded for 25 friends</div>';
                }
