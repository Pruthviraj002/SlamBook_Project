                ...
                if (!in_array($user['user_id'], $displayedUserIds)) {
                    ...
                    <?php if (!empty($user['Full_Name'])): ?>
                        ...
                        <div class="container mx-auto mt-4 p-4 bg-white rounded-md drop-shadow-md mb-4"
                            ...
                            <!-- Display images -->
                            <div class="flex">
                                <p class="toggle-button bg-cyan-400 text-xl lg:text-3xl text-center font-bold p-2 mb-2 rounded-md hover:bg-cyan-500 drop-shadow-md select-none w-5/6"
                                    onclick="toggleInfo('<?php echo $user['user_id']; ?>')">
                                    <span class="user-name">
                                        <?php echo $user['Full_Name']; ?>
                                    </span>
                                </p>
                                <a class="download-btn" href="download.php?user_id=<?php echo $user['user_id']; ?>"><button class="rounded-lg bg-green-500 text-center font-bold flex justify-end border-2 border-black hover:bg-green-700 hover:text-white p-1
                        ...
                        <div id="info_<?php echo $user['user_id']; ?>" class="user-info"
                            ...
                            <div class="bfa lg:flex w-full justify-evenly">
                                <div
                                    ...
                                    <hr>
                                    <div class="m-2 w-fit border-2 bg-white border-black">
                                        <div class="m-2">
                            ...
                            <div class="bg-black pt-1 mt-1 rounded-t-lg">
                                ...
                                <div class="image-slider" id="slider_<?php echo $user['user_id']; ?>">
                                    <?php
                                    ...
                                    foreach ($userImages as $image) {
                                        ?>
                                        <div class="bg-black rounded-lg border-2 border-white">

                                            <img src="uploads/<?php echo $image['image_url']; ?>" alt="Gallery Image"
                                                class="h-80 w-96 rounded-lg mx-auto border-4 border-double border-black m-4">
                                        </div>
                                        <?php
                                    }
                                    ?>
