...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (validateDateFormat($bday)) {
        ...
        if ($selectedDateTime->format('Y') > $currentDateTime->format('Y')) {
            ...
            $sql = "INSERT INTO questions (u_id, question1, question2, question3, Social_media) VALUES ('$userId3', '$q1', '$q2', '$q3', '$smedia')";
            $result = mysqli_query($conn, $sql);
            if ($result) {
...
';
    ...
    <form action="sbform.php" method="post" onsubmit="return validateForm()" enctype="multipart/form-data">
        ...
        <div class="sm:flex w-full">
            ...
            <div class="border-2 border-black bg-gradient-to-r from-slate-300 to-slate-500 rounded-xl m-2 p-1 sm:w-1/2">
                ...
                <div>
                    ...
                    <br>
                    <input type="text" name="food" id="food" class="w-full p-1 rounded-md" required>
                    <br>
                    <label class="text-lg font-bold p-1">Subject</label>
                    <br>
                    <input type="text" name="sub" id="sub" class="w-full p-1 rounded-md" required>
                    <br>
                    <label class="text-lg font-bold p-1">Movie</label>
                    <br>
                    <input type="text" name="movie" id="movie" class="w-full p-1 rounded-md" required>
                    <br>
                    <label class="text-lg font-bold p-1">Actor/Actress</label>
                    <br>
                    <input type="text" name="actor" id="actor" class="w-full p-1 rounded-md" required>
                    <br>
                    <label class="text-lg font-bold p-1">Colour</label>
                    <br>
                    <input type="text" name="clr" id="clr" class="w-full p-1 rounded-md" required>
                    <br>
                    <label class="text-lg font-bold p-1">Place/Country</label>
                    <br>
                    <input type="text" name="plce" id="plce" class="w-full p-1 rounded-md" required>
                    <br>
                    <label class="text-lg font-bold p-1">Singer</label>
                    <br>
                    <input type="text" name="sngr" id="sngr" class="w-full p-1 rounded-md" required>
                    <br>
                    <label class="text-lg font-bold p-1">Game/Sport</label>
                    <br>
                    <input type="text" name="game" id="game" class="w-full p-1 rounded-md" required>
                    <label class="text-lg font-bold p-1">Hobbies</label>
                    <br>
                    <input type="text" name="hoby" id="hoby" class="w-full p-1 rounded-md" required>
                </div>
            </div>
        ...
        <div class="border-2 border-black bg-gradient-to-r from-slate-300 to-slate-500 rounded-xl m-2 p-1">
            ...
            <input type="text" name="fgoals" id="fgoals" class="w-full p-1 rounded-md" required>

            <p class="text-lg font-bold p-1">Dream job</p>
            <input type="text" name="djob" id="djob" class="w-full p-1 rounded-md" required>

            <p class="text-lg font-bold p-1">Bucket list</p>
            <textarea type="text" name="blist" id="blist" class="w-full p-1 rounded-md" required></textarea>
        </div>
        ...
        <div class="border-2 border-black bg-gradient-to-r from-slate-300 to-slate-500 rounded-xl m-2 p-1">
            ...
            <textarea type="text" name="q1" id="q1" class="w-full p-1 rounded-md"></textarea>

            <p class="text-lg font-bold p-1">If you could be best friends with a character in any animated show,
                which would you choose?</p>
            <textarea type="text" name="q2" id="q2" class="w-full p-1 rounded-md"></textarea>

            <p class="text-lg font-bold p-1">If you could have one superpower,what would it be?</p>
            <textarea type="text" name="q3" id="q3" class="w-full p-1 rounded-md"></textarea>
        </div>
