...
';
    ...
    <div class=" w-full drop-shadow-2xl flex justify-center items-center">
        <div><img src="img/ulogin.png" alt="signup image" class="w-40 mt-2 mb-0 mx-auto">

            <div class="w-72 sm:w-96 h-fit sm:h-fit bg-slate-200 mx-auto rounded-xl shadow-lg relative">
                ...
                <form action="ulogin.php" method="post">
                    ...
                    <p class="text-base text-center mt-40 font-medium">Don't have an account?<a href="usignup.php"
